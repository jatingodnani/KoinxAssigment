  ...
  return (
    ...
    >
      <div className="flex w-full h-[30%] gap-2">
        ...
        <p
          className={`font-ubuntu p-2  text-[12px] text-center  rounded  ${
            percentageChangeNumber >= 0 ? "bg-[#8fd68f]" : "bg-[#ef7878]"
          }`}
        >
          {percentageChangeNumber && percentageChangeNumber.toFixed(2)}%
        </p>
      </div>
